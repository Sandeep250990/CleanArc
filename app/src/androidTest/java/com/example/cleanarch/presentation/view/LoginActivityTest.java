...
public class LoginActivityTest {
    ...
    Instrumentation.ActivityMonitor activityMonitor=getInstrumentation().addMonitor(UserActivity.class.getName(),null,false);
    ...
    public void checkButtonClickValidation(){
        ...
        checkValidEmail();
        checValidPwd();
        Intent intent = new Intent(getInstrumentation().getTargetContext(), UserActivity.class);
